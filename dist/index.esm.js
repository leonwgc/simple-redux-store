...
function useUpdateStore() {
  ...
  return useCallback(function (payload) {
    update(dispatch)(_objectSpread({}, payload));
  }, [dispatch]);
}

var exHistory = null; //browser,memory,hash
...
var configureStore = function configureStore(preloadedState) {
  var store = createStore(createRootReducer(exHistory), preloadedState, composeEnhancers(applyMiddleware(routerMiddleware(exHistory))));
  return store;
};

export default configureStore;
export { configureStore, history, useUpdateStore };
