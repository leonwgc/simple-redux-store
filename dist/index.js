...
var configureStore = function configureStore(preloadedState) {
  var store = redux.createStore(createRootReducer(exHistory), preloadedState, composeEnhancers(redux.applyMiddleware(connectedReactRouter.routerMiddleware(exHistory))));
  return store;
};
...
Object.defineProperty(exports, 'ConnectedRouter', {
  enumerable: true,
  get: function () {
    return connectedReactRouter.ConnectedRouter;
  }
});
